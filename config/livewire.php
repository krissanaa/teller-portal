...
return [
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value sets the path to the Livewire JavaScript asset.
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Echo / Broadcast configuration for Livewire (use Reverb)
    |--------------------------------------------------------------------------
    |
    | Configure the frontend broadcaster Livewire should use. By default
    | Livewire expects Pusher, but we run Reverb locally, so point it there.
    |
    */
    'echo' => [
        'broadcaster' => 'reverb',
