...
<div class="filter-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('admin.logs.index', array_merge(request()->query(), ['export' => 'csv'])) }}" class="btn btn-sm btn-success text-white">
    ...
    <form method="GET" action="{{ route('admin.logs.index') }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('admin.logs.index') }}" class="btn btn-secondary flex-grow-1 fw-bold text-center text-decoration-none">
