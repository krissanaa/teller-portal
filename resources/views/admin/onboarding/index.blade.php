    ...
    <div class="request-card">
        ...
        <div class="attachment-box">
            ...
            <button type="button"
                ...
                onclick="openAdminPreview('{{ $url }}', '{{ addslashes($fileName) }}', '{{ $extension }}', '{{ $publicUrl }}')">
