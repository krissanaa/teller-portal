...
<div class="container-fluid">
    ...
    <!-- Edit Form Card -->
    <div class="form-card">
        <form method="POST" action="<?php echo e(route('teller.requests.update', $request->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="store_name" class="form-control"
                                   value="<?php echo e(old('store_name', $request->store_name)); ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="business_type" class="form-control"
                                   value="<?php echo e(old('business_type', $request->business_type)); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="store_address" class="form-control" rows="3"
                                  required placeholder="ປ້ອນທີ່ຢູ່ຮ້ານຄ້າແບບລະອຽດ"><?php echo e(old('store_address', $request->store_address)); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="pos_serial" class="form-control"
                                   value="<?php echo e(old('pos_serial', $request->pos_serial)); ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="bank_account" class="form-control"
                                   value="<?php echo e(old('bank_account', $request->bank_account)); ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="installation_date" class="form-control"
                                   value="<?php echo e(old('installation_date', $request->installation_date)); ?>"
                                   required>
                        </div>
                            ...
                            <select name="branch_id" class="form-select" required>
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($branch->id); ?>"
                                            <?php echo e(old('branch_id', $request->branch_id) == $branch->id ? 'selected' : ''); ?>>
                            ...
                            <div class="position-relative drive-thumb"
                                ...
                                <?php else: ?>
                                    <div class="d-flex flex-column justify-content-center align-items-center bg-light h-100">
                                        ...
                                        <small><?php echo e(strtoupper($extension)); ?></small>
                                    </div>
                                <?php endif; ?>
                                <span class="drive-type"><?php echo e(strtoupper($extension)); ?></span>
                            </div>
                            <div class="mt-2 small text-truncate"><?php echo e($fileName); ?></div>

                            <!-- Delete checkbox -->
                            <div class="text-center mt-1">
                                <label class="form-check-label text-danger small" style="cursor:pointer;">
                                    <input type="checkbox" name="delete_attachments[]" value="<?php echo e($index); ?>" class="form-check-input me-1">
                                    ລົບຟາຍນີ້
                                </label>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-fullscreen"> <!-- 👈 ใช้ fullscreen modal -->
        <div class="modal-content bg-dark text-white border-0">
            ...
            <div class="form-actions">
                <a href="<?php echo e(route('teller.requests.show', $request->id)); ?>" class="btn-cancel">
