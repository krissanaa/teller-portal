...
<div class="detail-shell">
    <div class="detail-card">
        <div class="detail-header">
            <div>
                <span class="status-pill <?php echo e($req->approval_status); ?>"><?php echo e(ucfirst($req->approval_status)); ?></span>
                <h1><?php echo e($req->store_name ?? 'Unnamed Store'); ?></h1>
                <?php if($req->store_address): ?>
                    <p><i class="bi bi-geo-alt"></i> <?php echo e(Str::limit($req->store_address, 120)); ?></p>
                <?php endif; ?>
            </div>
            <div class="text-muted small">
                <?php if($req->created_at): ?>
                    <p class="mb-0"><i class="bi bi-calendar-event"></i> Submitted <?php echo e($req->created_at->format('M d, Y \\a\\t h:i A')); ?></p>
                <?php endif; ?>
                <p class="mb-0"><strong>Attachments:</strong> <?php echo e(count($attachments)); ?></p>
            </div>
        </div>
        ...
        <div class="chip-grid">
            <?php $__currentLoopData = $chips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="info-chip">
                    <i class="bi <?php echo e($chip['icon']); ?>"></i>
                    <div>
                        <strong><?php echo e($chip['label']); ?></strong>
                        <span><?php echo e($chip['value']); ?></span>
                    </div>
                </div>
        ...
        <div class="chip-grid">
            <div class="info-chip">
                ...
                <div>
                    ...
                    <span><?php echo e($req->installation_date ? \Carbon\Carbon::parse($req->installation_date)->format('M d, Y') : '-'); ?></span>
                </div>
            </div>
            <div class="info-chip">
                ...
                <div>
                    ...
                    <span><?php echo e(Str::title(str_replace('_', ' ', $req->store_status ?? 'Unknown'))); ?></span>
                </div>
            </div>
            <div class="info-chip">
                ...
                <div>
                    ...
                    <span><?php echo e($req->admin_remark ?? '—'); ?></span>
                </div>
            </div>
        </div>

        <div class="tag-row">
            <span><i class="bi bi-person-circle"></i> Teller ID: <?php echo e($req->teller_id ?? 'N/A'); ?></span>
            <span><i class="bi bi-upc-scan"></i> Refer: <?php echo e($req->refer_code ?? 'N/A'); ?></span>
        </div>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filePath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button type="button"
                            ...
                            onclick="openAdminPreview('<?php echo e($fileUrl); ?>', '<?php echo e(addslashes($fileName)); ?>', '<?php echo e($extension); ?>')">
                            ...
                            <div class="text-start">
                                <div class="fw-semibold"><?php echo e(Str::limit($fileName, 20)); ?></div>
        ...
        <div class="detail-actions">
            <a href="<?php echo e(route('admin.onboarding.index')); ?>" class="btn btn-outline-secondary">
                Back to requests
            </a>
        </div>
    </div>
