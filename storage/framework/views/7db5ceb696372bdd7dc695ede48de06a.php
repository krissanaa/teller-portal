...
<div class="main-container">
    <form method="POST" action="<?php echo e(route('teller.requests.store')); ?>" enctype="multipart/form-data" class="single-card" id="mainForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="store_name" class="form-control" required placeholder="ຊື່ຮ້ານຄ້າ" value="<?php echo e(old('store_name')); ?>">
            </div>

            <div class="form-group">
                <label>ປະເພດທຸລະກິດ <span class="required">*</span></label>
                <input type="text" name="business_type" class="form-control" required placeholder="ຕົວຢ່າງ: ຮ້ານອາຫານ" value="<?php echo e(old('business_type')); ?>">
            </div>

            <div class="form-group col-span-2">
                <label>ທີ່ຢູ່ຮ້ານຄ້າ <span class="required">*</span></label>
                <textarea name="store_address" class="form-control" rows="2" required placeholder="ບ້ານ, ເມືອງ, ແຂວງ"><?php echo e(old('store_address')); ?></textarea>
            </div>

            <!-- Row 2 -->
            <div class="form-group">
                <label>ເລກບັນຊີທະນາຄານ</label>
                <input type="text" name="bank_account" class="form-control" placeholder="ເລກບັນຊີ (ຖ້າມີ)" value="<?php echo e(old('bank_account')); ?>">
            </div>

            <div class="form-group">
                <label style="margin-top:0;">CIF</label>
                <input type="text" name="cif" class="form-control" placeholder="CIF" value="<?php echo e(old('cif')); ?>">
            </div>

            <div class="form-group">
                <label>ວັນທີເອົາໄປຕິດຕັ້ງ <span class="required">*</span></label>
                <input type="text" name="installation_date" class="form-control" required value="<?php echo e(old('installation_date', date('Y-m-d'))); ?>" placeholder="dd/mm/yyyy">
            </div>

            <div class="form-group">
                <label>ຈຳນວນເຄື່ອງ POS <span class="required">*</span></label>
                <input type="number" name="total_device_pos" class="form-control" required value="<?php echo e(old('total_device_pos')); ?>" placeholder="ຈຳນວນເຄື່ອງ" min="1">
            </div>
