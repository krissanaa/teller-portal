            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="store_name" class="form-control" required
                               placeholder="ປ້ອນຊື່ຮ້ານຄ້າ" value="<?php echo e(old('store_name')); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">
                        ...
                        <input type="text" name="business_type" class="form-control" required
                               placeholder="ເຊັ່ນ: ຮ້ານອາຫານ, ຮ້ານຂາຍເຄື່ອງ" value="<?php echo e(old('business_type')); ?>">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="store_address" class="form-control" rows="3" required
                              placeholder="ປ້ອນທີ່ຢູ່ຮ້ານຄ້າແບບລະອຽດ (ບ້ານ, ເມືອງ, ແຂວງ)"><?php echo e(old('store_address')); ?></textarea>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pos_serial" class="form-control" required
                               placeholder="ເຊັ່ນ: POS-2024-001" value="<?php echo e(old('pos_serial')); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">
                        ...
                        <input type="text" name="bank_account" class="form-control"
                               placeholder="ປ້ອນເລກບັນຊີ (ຖ້າມີ)" value="<?php echo e(old('bank_account')); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="installation_date" class="form-control" required
                               value="<?php echo e(old('installation_date', date('Y-m-d'))); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">
