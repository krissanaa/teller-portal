    ...
    <form method="POST" action="<?php echo e(route('teller.requests.store')); ?>" enctype="multipart/form-data" class="single-card" id="mainForm">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="business_type" class="form-control" required placeholder="ເຊັ່ນ: ຮ້ານອາຫານ" value="<?php echo e(old('business_type')); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="total_device_pos" class="form-control" required value="<?php echo e(old('total_device_pos')); ?>" placeholder="ລະບຸຈຳນວນເຄື່ອງ" min="1">
            </div>

            <!-- Row 2 -->
            <div class="form-group col-span-4">
                <label>ທີ່ຢູ່ຮ້ານຄ້າ <span class="required">*</span></label>
                <textarea name="store_address" class="form-control" rows="2" required placeholder="ປ້ອນທີ່ຢູ່ຮ້ານຄ້າແບບລະອຽດ"><?php echo e(old('store_address')); ?></textarea>
            </div>
