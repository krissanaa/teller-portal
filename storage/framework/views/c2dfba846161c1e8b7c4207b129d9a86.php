...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <h5 class="mb-3"><?php echo e($request->store_name); ?></h5>

            <div class="row">
                <div class="col-md-6">
                    <p><strong>ຊື່ຮ້ານຄ້າ:</strong> <?php echo e($request->store_name); ?></p>
                ...
                <div class="col-md-6">
                    <p><strong>ທີ່ຢູ່ຮ້ານຄ້າ:</strong> <?php echo e($request->store_address); ?></p>
                    <p><strong>ລະຫັດອ້າງອີງ:</strong> <?php echo e($request->refer_code); ?></p>
                    <p><strong>ລະຫັດເຄື່ອງ POS:</strong> <?php echo e($request->pos_serial ?? '-'); ?></p>
            ...
            <div class="alert alert-danger mt-3">
                <strong>ໝາຍເຫດຈາກຜູ້ອະນຸມັດ:</strong> <?php echo e($request->admin_remark); ?>
    ...
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('teller.requests.edit', $request->id)); ?>" class="btn btn-warning">✏️ ແກ້ໄຂຂໍ້ມູນ</a>
        <a href="<?php echo e(route('teller.dashboard')); ?>" class="btn btn-secondary">⬅️ ກັບຄືນ</a>
    </div>
</div>
