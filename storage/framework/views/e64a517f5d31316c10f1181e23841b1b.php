    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="teller_id" id="teller_id" class="form-control" value="<?php echo e(old('teller_id')); ?>" placeholder="">
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">ຊື່ <span class="required">*</span></label>
                <input type="text" name="name" id="name" class="form-control" required value="<?php echo e(old('name')); ?>" placeholder="">
            </div>

            <div class="mb-3">
                <label for="phone" class="form-label">ເບີໂທ <span class="required">*</span></label>
                <input type="text" name="phone" id="phone" class="form-control" required value="<?php echo e(old('phone')); ?>" placeholder="">
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="branch_id" id="branch_id" class="form-control" required>
                    ...
                    <option value="<?php echo e($branch->id); ?>" <?php echo e(old('branch_id') == $branch->id ? 'selected' : ''); ?>>
                        <?php echo e($branch->name ?? $branch->branch_name ?? 'Branch #'.$branch->id); ?>
            ...
            <div class="mb-3">
                ...
                <select name="unit_id" id="unit_id" class="form-control">
                    ...
                    <option value="<?php echo e($unit->id); ?>" data-branch-id="<?php echo e($unit->branch_id); ?>" <?php echo e(old('unit_id') == $unit->id ? 'selected' : ''); ?>>
                        <?php echo e($unit->name ?? $unit->unit_name ?? 'Unit #'.$unit->id); ?>
